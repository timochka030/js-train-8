...
function getElementAtIndex(arr, index) {
  ...
  //  else if (arr < at(index) && arr > at(index)) {
  //     return undefined;
  //   }
}
...
function findElementIndexes(arr, element) {
  ...
  //     let arrStrt = indexOf(arr, element);
  //     let arrLast = lastIndexOf(arr, element);
  //     let masive = Array.of(arrStrt, arrLast);
  //     return masive;
  //   } else {
  //     return Array();
  //   }
...
function customUnshift(arr, ...elements) {
  ...
  if (Array.isArray(arr)) {
    let initialLength = arr;

    for (let arr; arr >= 0; arr--) {
